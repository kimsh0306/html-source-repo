...
<body>
<!--<table id="dg" class="easyui-datagrid" data-options="url:'member.json'" title="데이터 출력 방법 종류"> -->
	<table id="dg" class="easyui-datagrid" style="width:600px" title="데이터 출력 방법 종류">
		<thead>
			<tr>
				<th data-options="field:'ENAME',with:150">이름</th>
			</tr>
		</thead>
		<tbody>
<%
...
%>			
	...
	<table border="1" title="데이터 출력 방법 종류" style="width:600px">
		<thead>
			<tr>
				<th>이름</th>
				<th>주소</th>
